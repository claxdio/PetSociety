              ...
              <div className="post-box">
                <div className="post-header">
                  {getAvatarContent(
                    ...
                    post.usuario_perfil?.foto_perfil_url
                  )}
                  <div className="user-info">
                    <span className="post-user">{post.usuario_username}</span>
                    {post.usuario_perfil?.tipo_usuario && (
                      <span
                        className={`user-type user-type-${post.usuario_perfil.tipo_usuario}`}
                      >
                        {post.usuario_perfil.tipo_usuario}
                      </span>
                    )}
            ...
            {sortedAnswers.map((answer) => (
              <div key={answer.id} className="post-wrapper">
                ...
                <div className="post-box">
                  <div className="post-header">
                    {getAvatarContent(
                      answer.usuario_username,
                      answer.usuario_perfil?.foto_perfil_url
                    )}
                    <div className="user-info">
                      ...
                      {answer.usuario_perfil?.tipo_usuario && (
                        <span
                          className={`user-type user-type-${answer.usuario_perfil.tipo_usuario}`}
                        >
                          {answer.usuario_perfil.tipo_usuario}
                        </span>
                      )}
